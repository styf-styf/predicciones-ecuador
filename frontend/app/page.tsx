...
function Carousel({ markets, renderCard, autoplayMs = 5000, visibleCount = 1 }: {
  ...
  <main className="min-h-screen bg-white dark:bg-[#0d0d0d] text-slate-900 dark:text-white">
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 py-6 space-y-6">
      ...
      {/* Tabla de mercados estilo Polymarket */}
      <div>
        ...
        <div className="divide-y divide-slate-100 dark:divide-white/[0.04]">
          {markets.map((market) => {
            ...
            return (
              <div key={market.id}
                className="grid grid-cols-1 sm:grid-cols-12 items-center gap-2 px-4 py-3.5 hover:bg-slate-50 dark:hover:bg-white/[0.02] transition group">
