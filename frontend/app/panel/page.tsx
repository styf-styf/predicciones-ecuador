            ...
            <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl p-5">
              ...
              {movimientos.length === 0 ? (
                <div className="py-6 text-center space-y-3">
                  ...
                  <Link href="/mercados" className="inline-flex items-center gap-2 bg-emerald-500 hover:bg-emerald-400 text-white text-sm font-bold px-4 py-2 rounded-xl transition active:scale-[0.99]">
