      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 py-12 space-y-10">
        ...
        {[
          ...
          },
          {
            ...
            content: `EcuaPred es una plataforma de entretenimiento que permite a los usuarios participar en mercados de predicción sobre eventos reales utilizando saldo virtual adquirido mediante recargas. El saldo virtual puede ser retirado según las condiciones establecidas en estos términos. EcuaPred no garantiza ganancias ni resultados específicos. La participación implica riesgo de pérdida del saldo invertido.`
          },
          {
          ...
          {
            title: "5. Registro y seguridad de la cuenta",
          ...
          {
            title: "10. Suspensión y cancelación de cuenta",
          ...
          {
            title: "13. Modificaciones del servicio y los términos",
          ...
          {
            title: "14. Resolución de conflictos y ley aplicable",
